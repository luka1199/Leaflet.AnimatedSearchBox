(function (factory, window) {
    ...
    L.Control.Searchbox = L.Control.extend({
      options: {
        ...
        // 'setValueOnClick', 'setValueOnHover'
        autocompleteFeatures: ['setValueOnClick'],
        clearItemsOnClickItem: false
      },
      ...
      onAdd: function (map) {
        ...
        if (this.options.autocompleteFeatures.includes('setValueOnHover')) {
          this.onAutocomplete('mouseover', function (e) {
            this._onListItemHover(e.target);
          });
        }
      ...
      _onListItemClick: function (item) {
        ...
        if(this.options.clearItemsOnClickItem){
          this.clearItems();
        }
      },
  
      _onListItemHover: function (item) {
        this.setValue(item.innerHTML);
        this._input.focus();
      },
